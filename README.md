...
<p>Campus Connect is a scalable social platform designed for university environments. It enables students to connect through events, groups, and discussions while using intelligent recommendations to surface relevant content and opportunities.</p>
<p>The project emphasizes community engagement, information discovery, and personalized experiences within a closed academic ecosystem.</p>
...
<ul>
  <li>🗓️ Event Discovery & Participation — Create and browse campus events with targeted visibility.</li>
  <li>💬 Groups & Communities — Join departmental, club, or interest-based groups.</li>
  <li>🔔 Real-Time Notifications — Updates for events, posts, and group activity.</li>
